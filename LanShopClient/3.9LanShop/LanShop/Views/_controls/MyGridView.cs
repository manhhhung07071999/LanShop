...
namespace System.Windows.Controls
{
    ...
    public class MyGridView : MyTableLayout, IDisposable
    {
        ...
        private void Row_PreviewMouseLeftButtonDown(object sender, Input.MouseButtonEventArgs e)
        {
        ...
        protected override void OnPreviewKeyUp(KeyEventArgs e)
        {
            ...
            switch (e.Key)
            {
                ...
                case Key.Delete:
                    r = GetRowByIndex(_selectedIndex);
                    if (r != null)
                    {
                        DeleteItem?.Invoke(r.Tag);
                    }
                    break;
            }
        }
        ...
        public event Action<object> DeleteItem;
