...
{ 
    public class Style
    {
        ...
        public Bound BorderSize
        {
            get { return (Thickness)_control.GetValue(Border.BorderThicknessProperty); }
            set { _control.SetValue(Border.BorderThicknessProperty, (Thickness)value); }
        }
